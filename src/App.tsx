            ...
            <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
                ...
                >
                    <h2 className="text-center text-xl md:text-4xl font-bold text-black dark:text-white">
                        Campaign for maps.fun by <a className="underline text-blue-700" href="https://x.com/pogul_saicharan" target="_blank">@pogul_saicharan</a>
                    </h2>
                ...
                <div className="absolute w-full -bottom-20 h-72 md:h-full z-10 opacity-70">
                    <World data={sampleArcs} globeConfig={globeConfig} />
                </div>
            </div>
        </div>
            <div className="fixed top-[50%] w-[90%] lg:w-[50%] left-[50%] z-[1500] translate-x-[-50%] translate-y-[-50%]">
                <Campaign campaignId={4449} displayMode="integrated" />
            </div>
        </BanditContextProvider>
    );
}
